...
<body>
    ...
    <div class="container spacer" style="">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <li class="list-group-item list-card list-card-slim">
                      <h6 class="theme-color-two"> Bill To <?php echo $jsonResult->Description . " : " . $jsonResult->Description3; ?> </h6>                      <div class="transDetailRow"> Send Funds to To: <span class="small text-light-grey"></span> : <span id="RequesteeEmail" class="transDetails theme-color-two" data-acctnum="<?php echo number_format($_POST["RequesteeEmail"], 2, '.', ''); ?></span></div>
                      <div class="transDetailRow"> Current Balance: <span class="small text-light-grey"> (Before Payment) </span> : <span id="accountBalance" class="transDetails theme-color-two" data-acctnum="<?php echo $jsonResult->AccountNumber; ?>"></span></div>
                      <div class="transDetailRow"> Transfer Amount: <span id="RequestedAmount" class="transDetails theme-color-two"><?php echo number_format($_POST["PaymentAmount"], 2, '.', ''); ?></span></div>
                      <div class="transDetailRow"> Transaction Fee: <span id="FundsRequestsChargeID" class="transDetails theme-color-two">0.00</span></div>
                      <div class="transDetailRow"> Closing Balance <span class="small text-light-grey"> (After Payment) </span> : <span id="closingBalance" class="transDetails theme-color-two"></span></div>
                  </li>
